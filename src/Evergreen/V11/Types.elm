...
type alias FrontendModel =
    ...
    , parsedIcsMatches : List Evergreen.V11.IcsParser.ParsedMatch
    , allParsedIcsMatches : List Evergreen.V11.IcsParser.ParsedMatch
...
type ToBackend
    ...
    | ChoosePredictedDateRequest String String String String
