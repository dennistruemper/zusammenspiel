...
type alias FrontendModel =
    ...
    , parsedIcsMatches : List Evergreen.V9.IcsParser.ParsedMatch
    , allParsedIcsMatches : List Evergreen.V9.IcsParser.ParsedMatch
...
type ToFrontend
    ...
    | TeamLoaded Team (List Match) (List Member) (List AvailabilityRecord) (Dict.Dict String (Dict.Dict String (Dict.Dict String DatePrediction)))
    | TeamNotFound
